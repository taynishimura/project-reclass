...
from toydiagram.diagrams.switch import Switch
from toydiagram.diagrams.host import Host
from toydiagram.diagrams.router import Router
...
class ToyDiagram():
  def __init__(self, routers, switches, links):
    ...
    diagramTree = DiagramTree(routers, switches, links)
